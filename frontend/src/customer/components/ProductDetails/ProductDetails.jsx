        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-col-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    {/* Product info */}
                    <div className="lg:col-span-1 mx-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Quan ao</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>jklhfjkafe</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>50 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>30 Reviews</p>
                                </div>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button
                                    ...
                                    variant='contained' sx={{ px: "2rem", py: "1rem", bgcolor: "#9155fd" }}>
                                    Add To Cart
                                </Button>
                            </form>
                        </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>30 Ratings</p>
                                </div>
                                ...
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant='determinate' value={40} />
                                        </Grid>
                                    </Grid>
